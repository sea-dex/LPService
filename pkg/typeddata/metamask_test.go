...
func (s *TypedDataSuite) TestTypedDataV3() {
	signature, err := SignTypedDataV4(s.typedDataV3, s.privateKey)
	s.Require().NoError(err)
	s.Require().Equal("0x4355c47d63924e8a72e509b65029052eb6c299d53a04e167c5775fd466751c9d07299936d304c153f6443dfa05f40ff007d72911b6f72307f996231605b915621c", hex.EncodeToHex(signature))
}
...
func (s *TypedDataSuite) TestTypedDataV4() {
	...
	signature, err := SignTypedDataV4(s.typedDataV4, s.privateKey)
	s.Require().NoError(err)
	s.Require().Equal("0x65cbd956f2fae28a601bebc9b906cea0191744bd4c4247bcd27cd08f8eb6b71c78efdf7a31dc9abee78f492292721f362d296cf86b4538e07b51303b67f749061b", hex.EncodeToHex(signature))
}
